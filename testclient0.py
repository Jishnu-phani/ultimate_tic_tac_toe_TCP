...
def connect_to_game(host,port):
    ...
    secure_sock = context.wrap_socket(client, server_hostname=host)
    secure_sock.connect((host,port))

    threading.Thread(target=handle_connection, args=(secure_sock,)).start()
...
connect_to_game("10.30.201.100",9999)